...
import { View, ScrollView, TouchableOpacity, Alert, StyleSheet, TextInput } from 'react-native';
...
export function ProductFormScreen({ route, navigation }: ProductFormScreenProps) {
  ...
  // Handle form save
  const handleSave = useCallback(async (productData: Product) => {
    setIsLoading(true);
  ...
  }, [productId, isCreateMode, navigation, t]);

  // Handle stock adjustment
  const handleStockAdjustment = useCallback(async (quantityChange: number, reason: string) => {
    if (!reason?.trim()) {
      Alert.alert(t('products:adjustmentReason'), t('products:validationRequired').replace('This field is required', t('products:adjustmentReason')));
      return;
    }
  ...
  const handleArchive = useCallback(async () => {
    const actionTitle = product?.is_active ? t('products:archive') : t('products:reactivate');
  ...
  }, [productId, product, t, navigation]);
          ...
          {product && (
            <ThemedView style={styles.form}>
              <ThemedText type="title" style={styles.title}>
                {t(isEditMode ? 'products:formTitle' : 'products:formTitle')}
              </ThemedText>

              <ThemedText type="subtitle" style={styles.subtitle}>
                {t(isEditMode ? 'products:formSubtitle' : 'products:formSubtitle')}
              </ThemedText>
              ...
              <FormField label={t('products:name')}>
                <TextInput
                  value={product?.name || ''}
                  onChangeText={value => setProduct(prev => ({ ...prev, name: value } as Product))}
              ...
              <FormField label={t('products:sku')}>
                <TextInput
                  value={product?.sku || ''}
                  onChangeText={value => setProduct(prev => ({ ...prev, sku: value || '' } as Product))}
              ...
              <FormField label={t('products:category')}>
                <TextInput
                  ...
                  onChangeText={value => setProduct(prev => ({ ...prev, category: value || '' } as Product))}
              ...
              <FormField label={t('products:salePrice')}>
                <TextInput
                  ...
                  onChangeText={value => {
                    ...
                    setProduct(prev => ({ ...prev, sale_price_centimes: num || 0 } as Product));
                  }}
              ...
              <FormField label={t('products:costPrice')}>
                <TextInput
                  ...
                  onChangeText={value => {
                    const num = parseInt(value.replace(/[^0-9]/g, ''), 10);
                    setProduct(prev => ({ ...prev, cost_price_centimes: num || 0 } as Product));
                  }}
                  keyboardType="numeric"
                  placeholder={t('products:placeholder')}
                  style={styles.input}
              ...
              <FormField label={t('products:stock')}>
                <TextInput
                  ...
                  onChangeText={value => {
                    ...
                    setProduct(prev => ({ ...prev, stock_quantity: num || 0 } as Product));
                  }}
                  keyboardType="numeric"
                  placeholder="0"
                  style={styles.input}
              ...
              <FormField label={t('products:minimumStock')}>
                <TextInput
                  ...
                  onChangeText={value => {
                    const num = parseInt(value, 10);
                    setProduct(prev => ({ ...prev, minimum_stock_quantity: num || 0 } as Product));
                  }}
                  keyboardType="numeric"
                  placeholder="0"
                  style={styles.input}
              ...
              <FormField label={t('products:unit')}>
                <TextInput
                  ...
                  onChangeText={value => setProduct(prev => ({ ...prev, unit: value } as Product))}
                  style={styles.input}
                >
                  <ThemedText type="small" style={styles.hint}>
              ...
              {!isCreateMode && (
                <View style={styles.adjustmentSection}>
                  ...
                  <TouchableOpacity style={styles.adjustmentButton} onPress={() => {
                    navigation?.push('stock-adjustment', {
                      productId: product.id,
                      productName: product.name,
                      currentStock: product.stock_quantity,
                    });
                  }}>
                    <ThemedText type="small" style={styles.adjustmentButtonText}>
